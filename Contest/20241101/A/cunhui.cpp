...
namespace solution
{
    ...
    int mian()
    {
        ...
        for (auto i : as)
        {
            sa = sa + pa * qpow(i), sa %= MOD;
        }

        io.writeln(pc == sa ? 'S' : 'N');
